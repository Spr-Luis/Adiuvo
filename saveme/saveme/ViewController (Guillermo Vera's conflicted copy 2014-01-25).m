...
- (IBAction)moreButtonPressed:(id)sender {
    ...
    [seeButton addTarget:nil action:@selector(back) forControlEvents:UIControlEventTouchDown];
    ...
    [followButton addTarget:nil action:@selector(back) forControlEvents:UIControlEventTouchDown];
