...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [Parse setApplicationId:@"MlKy98FVeNPNsvh2IW910UIrBnbdorGlaedjnbGH"
                  clientKey:@"OlFwNDWnpsEvAI1M87YF3gbtz8T3UFM2fIq4piCq"];
    ...
    NSDictionary *settings = @{UITextAttributeFont:[UIFont boldSystemFontOfSize:17],UITextAttributeTextColor:[UIColor whiteColor]};
    [[UINavigationBar appearance] setTitleTextAttributes:settings];
    [[UIApplication sharedApplication] setStatusBarStyle:UIStatusBarStyleLightContent];
    
    
    //  [[UIApplication sharedApplication]setStatusBarStyle:UIStatusBarStyleLightContent animated:YES];
    //set my nav bar image
    // self.navi
    //Im not coming from unity
    [[UINavigationBar appearance] setBackgroundImage:[UIImage imageNamed:@"A.png"] forBarMetrics:UIBarMetricsDefault];
...
- (void)applicationDidEnterBackground:(UIApplication *)application
{
    ...
    notif.alertBody = @"Ayudanos a encontrar a las personas desaparecidas cerca de aqui !";
